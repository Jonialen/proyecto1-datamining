...
* Para hacer una investigación formal es necesario basarse en una situación problemática y por consiguiente un problema que justifique la investigación.


* Es importante revisar la teoría que rodea la problemática y los antecedentes de investigaciones similares.


* La investigación puede ser aplicada a diversos temas incluyendo finanzas, economía y negocios.


* El Instituto Nacional de Estadística (INE) tiene numerosas Bases de Datos. Algunas pueden usarse para explorar cómo se está comportando la sociedad guatemalteca, por ejemplo, las bases de datos de estadísticas vitales y las de violencia.


* En la de estadísticas vitales, se pueden encontrar 5 conjuntos de datos por año desde 2009 hasta 2022 ([https://www.ine.gob.gt/ine/vitales/](https://www.ine.gob.gt/ine/vitales/)): Nacimientos, Matrimonios, Divorcios, Defunciones y Defunciones Fetales.


* En la de violencia, hay 5 conjuntos de datos, pero particularmente 3 resultan interesantes: Hechos delictivos, Violencia intrafamiliar y Violencia en contra de la mujer y delitos sexuales.


* Deben trabajar con uno o varios de los conjuntos de datos antes mencionados.


* Tengan en cuenta que deben trabajar con más de 10 años de datos, así que es posible que tengan que hacer transformaciones para unir los archivos de cada año.


* Tenga cuidado con los datos que se encuentran en la página del INE, debe trabajar con los datos crudos, generalmente en formato .sav.


* El objetivo principal es explorar los datos para obtener preguntas interesantes.


* Si tienen acceso a otros conjuntos de datos que creen puedan servirles, son libres de utilizarlos, respetando siempre las condiciones de quien los publica.
...
2. 
**Una vez hayan explorado los datos:** 
...
* 
**Situación Problemática (10 puntos):** Describe la situación problemática que da lugar al problema.


* **Problema científico (10 puntos):** Enuncia el problema científico que se desprende de la situación planteada. Comprende bien cuál es el problema.


* **Objetivos (10 puntos):** Plantea los objetivos a cumplir para darle solución al problema planteado. Enuncia al menos un objetivo general y 2 específicos. Los objetivos deben ser medibles y alcanzables durante la investigación.


* 
**Descripción de los datos (15 puntos):** Describe los datos, tanto las variables y observaciones como las operaciones de limpieza que se hicieron si fueron necesarias.


* 
**Análisis Exploratorio (35 puntos):** 


* Estudian las variables cuantitativas mediante técnicas de estadística descriptiva. Presentan gráficos exploratorios como histogramas, diagramas de cajas y bigotes, gráficos de dispersión, que ayudan a explicar los datos.
...
* Estudian las variables categóricas. Elaboran gráficos de barra, tablas de frecuencia y de proporciones.
...
* 
**Hallazgos y conclusiones (20 puntos):** 
...
> **Nota:** El uso de paquetes y módulos para hacer Análisis Exploratorio de forma automática, no está permitido.
