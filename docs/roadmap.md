...
- [x] Revisión final del informe por parte del usuario.

### Fase 4: Entregables Finales

- [x] Exportar notebook a HTML/PDF (limpio, sin errores).
- [x] Generar PDF del informe formal.
- [x] Realizar `git push` final al repositorio.
